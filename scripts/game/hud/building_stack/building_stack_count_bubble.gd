...
## Array of font sizes indexed by the order of magnitude of the building stack
...
func set_count(amount: int) -> void:
	_count = amount
	%BuildingStackCountLabel.text = "%d🏠" % _count
	_update_font_size()
...
func _update_font_size() -> void:
	...
	%BuildingStackCountLabel.add_theme_font_size_override(
			&"font_size",
