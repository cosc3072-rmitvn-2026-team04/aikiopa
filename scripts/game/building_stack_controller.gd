...
## The [enum Building.BuildingType]s generated by this
## [BuildingStackController].
const GENERATED_BUILDING_TYPES: Array[Building.BuildingType] = [
...
func add_building() -> void:
	...
	var new_building_type: Building.BuildingType =\
			GENERATED_BUILDING_TYPES[new_building_type_index]
