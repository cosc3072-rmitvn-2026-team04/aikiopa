...
const ATLAS_COORDS: Dictionary[World.TerrainTypes, Vector2i] = {
	...
	World.TerrainTypes.Grassland: Vector2i(1, 1),
	World.TerrainTypes.GrasslandForest: Vector2i(1, 1),
	World.TerrainTypes.GrasslandMountain: Vector2i(1, 1),
	World.TerrainTypes.GrasslandChasm: Vector2i(1, 1),
