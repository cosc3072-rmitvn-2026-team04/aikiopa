...
static func save(game_state: Global.GameState, slot_index: int) -> bool:
	...
	file.store_var(game_state.card_stack_seed, false)
	file.store_var(game_state.card_stack_state, false)
	file.store_var(game_state.card_stack, false)
...
static func load(slot_index: int) -> Global.GameState:
	...
	game_state.card_stack_seed = file.get_var(false)
	game_state.card_stack_state = file.get_var(false)
	game_state.card_stack = file.get_var(false)
